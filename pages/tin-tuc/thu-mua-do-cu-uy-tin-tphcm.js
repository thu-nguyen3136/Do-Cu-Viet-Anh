...
export default function Article() {
  return (
    <>
      <Head>
        <title>Đơn Vị Thu Mua Đồ Cũ Uy Tín Tại TP.HCM Giá Cao | Việt Anh</title>
        <meta
          name="description"
      ...
      <main className="bg-white">
        <article className="max-w-[900px] mx-auto px-6 py-10 md:py-14">
          ...
          <div className="text-gray-500 text-sm mb-6">
            Cập nhật: 2026 | Dịch vụ thu mua đồ cũ Việt Anh
          </div>
          ...
          <h2 className="text-2xl font-black text-[#111827] mt-10 mb-4">
            Lợi Ích Khi Sử Dụng Dịch Vụ Thu Mua Đồ Cũ Tại Việt Anh
          </h2>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 mb-6">
            <p className="text-gray-700">
              Xem thêm dịch vụ: <Link href="/thu-mua-do-go" className="text-[#e08a0d] font-semibold hover:underline">Thanh lý đồ gỗ tại TP.HCM</Link>
            </p>
          </div>
          ...
          {/* H2: Sản phẩm thu mua */}
          <h2 className="text-2xl font-black text-[#111827] mt-10 mb-4">
            Các Loại Đồ Cũ Việt Anh Thu Mua
          </h2>

          <p className="text-gray-700 leading-relaxed mb-4">
            Việt Anh nhận thu mua đa dạng các loại sản phẩm, bao gồm:
          </p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 mb-6">
            <p className="text-gray-700">
              Khám phá thêm: <Link href="/thu-mua-cua-cu" className="text-[#e08a0d] font-semibold hover:underline">Thu mua cửa cũ giá cao</Link>
            </p>
          </div>
          ...
          <p className="text-gray-700 mb-4">
            Chắc chắn, Việt Anh thu mua tất cả đồ cũ còn sử dụng được, từ nội thất, thiết bị điện tử đến đồ công nghiệp, với mức giá sát thị trường.
          </p>
